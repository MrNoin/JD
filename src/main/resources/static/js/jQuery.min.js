...
// 在另一个地方无人看守，只为这个模块定义全局似乎更安全
    ...
    // jQuery.support 未在 Core 中使用，但其他项目附加了
    // 属性，所以它需要存在。
    支持：支持
});
...
“ATTR”：函数（匹配）{
        ...
        // 将给定值移动到 match[3]，无论是带引号的还是不带引号的
        匹配[ 3 ] = ( 匹配[ 3 ] || 匹配[ 4 ] ||
...
“标签”：函数（节点名称选择器）{
        ...
        ：
				功能（元素）{
                返回 elem.nodeName && elem.nodeName.toLowerCase() === nodeName;
            };
        },
...
if ( !support.attributes || !assert( function( el ) {
    ...
    返回 el.firstChild.getAttribute( "value" ) === "";
} ) ) {
